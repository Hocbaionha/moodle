...
$url = new moodle_url('/local/class_regist/register.php');
$PAGE->set_context($sitecontext);
$PAGE->set_url($url);

$PAGE->set_title("register");
$PAGE->set_heading(get_string("register", "local_class_regist"));
...
if($check){
   $returnurl = new moodle_url('/local/class_regist/step1.html');
   echo "fail";die;
}
?>
<!DOCTYPE html>
<html>
   <head>
      <meta charset="UTF-8">
      <title>Đăng ký mở tài khoản hocbaionha.com</title>
      <meta http-equiv="Cache-Control" content="no-cache">
      <meta http-equiv="Expires" content="-1">
      <meta name="keywords" content="hocbaionha.com">
      <meta name="description" content="Trang dành cho phụ huynh đăng ký mở tài khoản cho con theo hướng dẫn của nhà trường">
      <script id='script_viewport' type='text/javascript'>window.ladi_viewport = function () {var width = window.outerWidth > 0 ? window.outerWidth : window.screen.width;var widthDevice = width;var is_desktop = width >= 768;var content = "";if (typeof window.ladi_is_desktop == "undefined" || window.ladi_is_desktop == undefined) {window.ladi_is_desktop = is_desktop;}if (!is_desktop) {widthDevice = 320;} else {widthDevice = 960;}content = "width=" + widthDevice + ", user-scalable=no";var scale = 1;if (!is_desktop && widthDevice != window.screen.width && window.screen.width > 0) {scale = window.screen.width / widthDevice;}if (scale != 1) {content += ", initial-scale=" + scale + ", minimum-scale=" + scale + ", maximum-scale=" + scale;}var docViewport = document.getElementById("viewport");if (!docViewport) {docViewport = document.createElement("meta");docViewport.setAttribute("id", "viewport");docViewport.setAttribute("name", "viewport");document.head.appendChild(docViewport);}docViewport.setAttribute("content", content);};window.ladi_viewport();</script>
      <link rel="canonical" href="https://dangky.hocbaionha.com/english-everyday" />
      <meta property="og:url" content="https://dangky.hocbaionha.com/english-everyday" />
      <meta property="og:title" content="Đăng ký mở tài khoản hocbaionha.com" />
      <meta property="og:type" content="website" />
      <meta property="og:description" content="Trang dành cho phụ huynh đăng ký mở tài khoản cho con theo hướng dẫn của nhà trường" />
    ...
    #BUTTON156 { width: 91px;height: 33px;top: 460px;left: 145px;}#BUTTON156 > .ladi-button > .ladi-button-background { background-color: rgb(180, 180, 180);}#BUTTON156 > .ladi-button { border-color: rgb(255, 255, 255); border-width: 5px; border-radius: 5px;}#BUTTON_TEXT56 { width: 116px;top: 9px;left: 0px;}#BUTTON_TEXT56 > .ladi-headline { color: rgb(0, 0, 0); font-size: 16px; text-align: center; line-height: 1.6;}
     div#schedule {
       color:red;
       margin-top:-20px;
       padding-left:120px;
    ...
    #POPUP55 { width: 500px;height: 120px;top: 0px;left: 0px;bottom: 0px;right: 0px;margin: auto;}#POPUP55 > .ladi-popup > .ladi-overlay { border-radius: 20px;}#POPUP55 > .ladi-popup > .ladi-popup-background { background-color: rgb(255, 255, 255); border-radius: 20px;}#POPUP55 > .ladi-popup { box-shadow: 0px 15px 20px -20px #000; -webkit-box-shadow: 0px 15px 20px -20px #000; border-radius: 20px;}
    #POPUP56 { width: 500px;height: 120px;top: 0px;left: 0px;bottom: 0px;right: 0px;margin: auto;}#POPUP56 > .ladi-popup > .ladi-overlay { border-radius: 20px;}#POPUP56 > .ladi-popup > .ladi-popup-background { background-color: rgb(255, 255, 255); border-radius: 20px;}#POPUP56 > .ladi-popup { box-shadow: 0px 15px 20px -20px #000; -webkit-box-shadow: 0px 15px 20px -20px #000; border-radius: 20px;}
    
    #PARAGRAPH56 { width: 500px;top: 8px;left: 0px;}#PARAGRAPH56 > .ladi-paragraph { color: rgb(16, 72, 145); font-size: 16px; line-height: 1.6;}
    #PARAGRAPH57 { width: 500px;top: 40px;left: 0px;}#PARAGRAPH57 > .ladi-paragraph { color: rgb(16, 72, 145); font-size: 16px; line-height: 1.6;}
    #PARAGRAPH55 h3{
      ...
      td.cell.c5,td.cell.c6,td.cell.c7{
         display:none;
      }
      span#linkzoom{
         padding-left: 35px;
         ...
         <div id="SECTION1" class='ladi-section'>
            ...
            <div class="ladi-container">
               ...
               <div  id="HEADLINE59" class='ladi-element'>
                  <h3 class='ladi-headline'>Hãy chọn lớp học &nbsp;<br></h3>
               </div>
                     <div id="FORM6" data-config-id="5f9bcd5ddfcdfd0807990644" class='ladi-element'>

                         <div class="container">
                             <div class="table-responsive">
                                <form action="/local/class_regist/register_submit.php" method="post" id="form">
  <?PHP
echo "<input type='hidden' value='$name' name='name' />";
echo "<input type='hidden' value='$school' name='school' />";
echo "<input type='hidden' value='$class' name='class' />";
echo "<input type='hidden' value='$province' name='province' />";
...
$returnurl = new moodle_url('/local/class_regist/register.php', array('perpage' => $perpage, 'page' => $page));
...
$table->head = array($hcolumns['choose'], $hcolumns['name'], $hcolumns['level'], $hcolumns['schedule'],$hcolumns['limit']);
...
$table->attributes['id'] = 'table1';
    ...
    foreach ($rs as $s) {
       ...
       $slot = $s->limited-$count;
        $buttons = array();
        $row = array();
        if($slot>0){
         $row[] = "<input type='radio' value='$s->id' name='choose' onclick='doSubmit($s->id)'/>";
        } else {
         $row[] = "<input type='radio' value='$s->id' name='choose' disabled/>";
        }
        
        $row[] = $s->name;
        $row[] = $s->level;
        $row[] = str_replace(",","<br/>",$s->schedule);
...
?>
         ...
         <div id="SECTION_POPUP" class='ladi-section'>
            <div class='ladi-section-background'></div>
            <div class="ladi-container">
               <div id="POPUP54" class='ladi-element'>
                  <div class='ladi-popup'>
                     <div class="ladi-popup-background"></div>
                     <div class="ladi-overlay"></div>
                     <div  id="PARAGRAPH55" class='ladi-element'>
                        <h3 class='ladi-headline' style="text-align:center;margin-top:30px;margin-bottom:20px;">Xác nhận đăng ký</h3>
                        <p class='ladi-paragraph'>Họ và tên: <b><?PHP echo $name;?></b></p>
                        <p class='ladi-paragraph'>Lớp: <b><?PHP echo $class;?></b></p>
                        <p class='ladi-paragraph'>Trường: <b><?PHP echo $school;?></b></p>
                        <p class='ladi-paragraph'>Tỉnh/Thành phố: <b><?PHP echo $province;?></b></p>
                        <p class='ladi-paragraph'>Số điện thoại: <b><?PHP echo $phone;?></b></p>
                        <p class='ladi-paragraph'>Đăng ký học lớp: <b><span id='sname'></span></b></p>
                        <p class='ladi-paragraph'>Lịch học: <b><div id='schedule'></div></b></p>
                        <p class='ladi-paragraph'>Link phòng học Zoom: <b><span id='linkzoom'></span></b></p>
                        <p class='ladi-paragraph'>hoặc</p>
                        <p class='ladi-paragraph' style="padding-left:35px">Zoom ID: <b><span id='zoomid'></span></b></p>
                        <p class='ladi-paragraph' style="padding-left:35px">Password: <b><span id='zoompass'></span></b></p>
                        <p class='ladi-paragraph' style="color:#C73A1F"> <i>(Vui lòng chụp ảnh hoặc lưu lại thông tin để vào học) </i></p>
                     </div>
                     <div  id="BUTTON56" class='ladi-element'>
                        <div class='ladi-button'>
                           <div class="ladi-button-background"></div>
                           <div  id="BUTTON_TEXT56" class='ladi-element' style="background-color:#ABDEFF;">
                              <p class='ladi-headline'><span >Đồng ý</span></p>
                           </div>
                        </div>
                     </div>
                     <div  id="BUTTON156" class='ladi-element' onclick='$("#POPUP54").hide();'>
                        <div class='ladi-button'>
                           <div class="ladi-button-background"></div>
                           <div  id="BUTTON_TEXT56" class='ladi-element' style="background-color:#FCB402;">
                              <p class='ladi-headline'><span >Hủy </span></p>
                           </div>
                        </div>
                     </div>
                  </div>
               </div>
               <div id="POPUP55" class='ladi-element'>
                  <div class='ladi-popup'>
                     <div class="ladi-popup-background"></div>
                     <div class="ladi-overlay"></div>
                     <div  id="PARAGRAPH56" class='ladi-element'>
                        <p class='ladi-paragraph' style="text-align:center;margin-top:20px;">Chúc mừng</p>
                        <p class='ladi-paragraph'style="text-align:center;">Bạn đã đăng ký thành công</p>
                     </div>
                     
                  </div>
               </div>
               <div id="POPUP56" class='ladi-element'>
                  <div class='ladi-popup'>
                     <div class="ladi-popup-background"></div>
                     <div class="ladi-overlay"></div>
                     <div  id="PARAGRAPH57" class='ladi-element'>
                        <p class='ladi-paragraph'style="text-align:center;">Bạn đã đăng ký rồi</p>
                     </div>
      ...
      <script>
         $("#BUTTON56").click(function(){        
            $("#form").submit(); // Submit the form
         });
        function doSubmit(id){
            console.log(id);
            $('.table').each(function() {
               var tr = $(this).find("tr").eq(id);    
               $("#sname").text(tr.find("td").eq(1).html());    
               $("#schedule").html(tr.find("td").eq(3).html());
               $("#linkzoom").html(tr.find("td").eq(5).html());
               $("#zoomid").html(tr.find("td").eq(6).html());
               $("#zoompass").html(tr.find("td").eq(7).html());
            });
            $("#POPUP54").show();
         }
