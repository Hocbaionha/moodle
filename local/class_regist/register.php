...
<html>
   <head>
    ...
    #BUTTON156 { width: 91px;height: 33px;top: 330px;left: 355px;}#BUTTON156 > .ladi-button > .ladi-button-background { background-color: rgb(180, 180, 180);}#BUTTON156 > .ladi-button { border-color: rgb(255, 255, 255); border-width: 5px; border-radius: 5px;}#BUTTON_TEXT56 { width: 116px;top: 9px;left: 0px;}#BUTTON_TEXT56 > .ladi-headline { color: rgb(0, 0, 0); font-size: 16px; text-align: center; line-height: 1.6;}
    .ladi-paragraph span {
       color:red;
    }
               ...
               <div id="POPUP54" class='ladi-element'>
                  <div class='ladi-popup'>
                     ...
                     <div  id="PARAGRAPH55" class='ladi-element'>
                        <p class='ladi-paragraph' style="text-align:center;margin-top:30px;">Xác nhận đăng ký</p>
                        <p class='ladi-paragraph'>Họ và tên:<?PHP echo $name;?></p>
                        <p class='ladi-paragraph'>Lớp:<?PHP echo $class;?></p>
                        <p class='ladi-paragraph'>Trường:<?PHP echo $school;?></p>
                        <p class='ladi-paragraph'>Tỉnh/Thành phố:<?PHP echo $province;?></p>
                        <p class='ladi-paragraph'>Số điện thoại:<?PHP echo $phone;?></p>
                        <p class='ladi-paragraph'>Đăng ký học lớp:<span id='sname'></span></p>
                        <p class='ladi-paragraph'>Lịch học:<br><span id='schedule'></span></p>
                     </div>
                     <div  id="BUTTON56" class='ladi-element'>
                        <div class='ladi-button'>
                           <div class="ladi-button-background"></div>
                           <div  id="BUTTON_TEXT56" class='ladi-element'>
                              <p class='ladi-headline'><span style="font-weight: bold;">ĐỒNG Ý</span></p>
                           </div>
                        </div>
                     </div>
                     <div  id="BUTTON156" class='ladi-element' onclick='$("#POPUP54").hide();'>
                        <div class='ladi-button'>
                           <div class="ladi-button-background"></div>
                           <div  id="BUTTON_TEXT56" class='ladi-element'>
                              <p class='ladi-headline'><span style="font-weight: bold;">HỦY</span></p>
                           </div>
                        </div>
                     </div>
                  </div>
