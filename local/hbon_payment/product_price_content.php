                        ...
                        <ul class="list-unstyled text-left">
                            <li><i class="fa fa-check text-success"></i> Chuyển khoản theo thông tin:
                                <ul >
                                    ...
                                    <li style="padding-left: 15px; margin-left: 18px;">
                                        <?php if($product->id == 1) echo 'Ví dụ: <span  class="pay_syntax">Luyện thi Toán – thutrang2020 – 0989.xxx.xxx</span>';?>
                                        <?php if($product->id == 2) echo 'Ví dụ: <span  class="pay_syntax">Luyện thi Văn  – thutrang2020 – 0989.xxx.xxx</span>';?>
                                        <?php if($product->id == 3) echo 'Ví dụ: <span  class="pay_syntax">Luyện thi Anh – thutrang2020 – 0989.xxx.xxx</span>';?>
                                        <?php if($product->id == 7) echo 'Ví dụ: <span  class="pay_syntax">Luyện thi Toán Văn Anh – thutrang2020 – 0989.xxx.xxx</span>';?>
                                        <?php if($product->id == 9) echo 'Ví dụ: <span  class="pay_syntax">HBON Math – thutrang2020 – 0989.xxx.xxx</span>';?>
                                        <?php if($product->id == 11) echo 'Ví dụ: <span  class="pay_syntax">ON Math Live  – thutrang2020 – 0989.xxx.xxx</span>';?>
                                        <?php if($product->id == 15) echo 'Ví dụ: <span  class="pay_syntax">Skills Builder  – thutrang2020 – 0989.xxx.xxx</span>';?>
                                    </li>
                                </ul>
                            </li>
