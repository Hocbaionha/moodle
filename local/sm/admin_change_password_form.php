...
class admin_login_change_password_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('header', 'changepassword', "Đặt lại mật khẩu", '');

        // visible elements
        $mform->addElement('static', 'username', get_string('username'), $email );
        ...
        $mform->addElement('hidden', 'email', null);
