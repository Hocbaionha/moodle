...
define(['jquery', 'jqueryui', 'theme_classon/slick'], function ($, jqui, Slick) {
    return {
        classon_homepage: function ($params) {
            console.log("Run classon homepage JS");
            function classon_init_carousel($elem) {
