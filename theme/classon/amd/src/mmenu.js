!function(e) {
    ...
    var M = function() {
            ...
            return e.prototype.openPanel = function(e, t) {
                        ...
                        if (i && i.length > 1 && "#" == i.slice(0, 1)) {
                            try {
                                ...
                                if (s && s.matches(".mm-panel")) {
                                    return t.parentElement.matches(".mm-listitem_vertical") ? e.togglePanel(s) : e.openPanel(s), !0;
                                }
                            } catch (e) {
                            }
                        }
                ...
                var t = this;
                if (this.trigger("initPanel:before", [e]), x(e, this.conf.classNames.panel, "mm-panel"), x(e, this.conf.classNames.nopanel, "mm-nopanel"), x(e, this.conf.classNames.inset, "mm-listview_inset"), e.matches(".mm-listview_inset") && e.classList.add("mm-nopanel"), e.matches(".mm-nopanel")) {
                    return null;
                }
                var n = e.id || l(),
        ...
        offcanvas: function() {
            ...
            if (t.scroll && this.bind("close:finish", (function() {
                ...
                if (n = null, i.inMenu) {
                    ...
                    if (n = a(o)) {
                        return e.node.menu.matches(".mm-menu_sidebar-expanded") && e.node.wrpr.matches(".mm-wrapper_sidebar-expanded") ? void s() : {close: !0};
                    }
                }
            })), t.update) {
                var r = [];
