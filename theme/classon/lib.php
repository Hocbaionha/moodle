 ...
 * @return string
 */
function theme_classon_get_main_scss_content($theme) {
    global $CFG;
 ...
 * @param $settingname
 */
function theme_classon_update_settings_images($settingname) {
    global $CFG;
    ...
    $pathname = $CFG->dataroot . '/pix_plugins/theme/classon/' . $settingname . '.' . $extension;

    // This pattern matches any previous files with maybe different file extensions.
    $pathpattern = $CFG->dataroot . '/pix_plugins/theme/photo/' . $settingname . '.*';

    // Make sure this dir exists.
    @mkdir($CFG->dataroot . '/pix_plugins/theme/classon/', $CFG->directorypermissions, true);
