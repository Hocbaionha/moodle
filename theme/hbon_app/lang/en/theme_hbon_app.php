...
$string['choosereadme'] = 'Theme hbon_app is a child theme of Boost. It adds the ability to upload background photos.';
// Name of the settings pages.
$string['configtitle'] = 'Thiết lập cho hbon_app';
...
$string['slideshowsettingsheading'] = 'Customize the carousel on the front page. See the layout <a href="./../theme/hbon_app/pix/layout.png" target="_blank"> here</a>';
