...
if ($USER->id != 2) {
    ...
    $PAGE->requires->css('/theme/hbon_app/style/killCopy.css');
    $PAGE->requires->js('/theme/hbon_app/amd/src/killCopy.js');
}
echo $OUTPUT->render_from_template('theme_hbon_app/columns2', $templatecontext);
